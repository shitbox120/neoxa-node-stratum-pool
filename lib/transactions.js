...
var generateOutputTransactions = function(poolRecipient, recipients, rpcData, devSubsidy){
    ...
    if(devSubsidy != null){
        if(rpcData.height >= devSubsidy.startHeight && rpcData.height % devSubsidy.blockInterval === 0){
            var script = util.addressToScript(devSubsidy.recipient);
            txOutputBuffers.push(Buffer.concat([
                util.packInt64LE(devSubsidy.amount),
